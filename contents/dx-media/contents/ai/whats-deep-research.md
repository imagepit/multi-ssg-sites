...
---
![](../../../../images/dx-media/ai/whats-deep-research.png)
## Deep Researchとは？

Deep Researchとは、OpenAIが開発した最先端のAIリサーチエージェント機能で、現在はGoogle GeminiやPerplexityなど他のAIプラットフォームにも広がっている革新的な技術です。これは単なる検索機能ではなく、**パブリックWeb上の情報を自律的に探索・分析し、包括的なレポートを生成するAIエージェント**です。
...
*Google Gemini Deep Researchのイメージ* [Google Blog](https://blog.google/products/gemini/google-gemini-deep-research/)
...
[OpenAI](https://openai.com/index/introducing-deep-research/)や[Google](https://blog.google/products/gemini/google-gemini-deep-research/)といった大手AI企業の積極的な開発投資により、今後この分野はさらに発展していくことが予想されます。
...
| 機能 | ChatGPT Deep Research | Google Gemini Deep Research |
|------|----------------------|----------------------------|
| **基盤モデル** | o3モデル | Gemini 1.5 Pro |
| **情報収集範囲** | ウェブ全般、PDF、画像解析を含む | ウェブ全般（Googleの検索技術を活用） |
| **コンテキスト処理** | 長文脈処理 | 最大100万トークンのコンテキスト処理 |
| **リサーチプロセス** | 自律的に検索、分析、統合を繰り返す | 複数ステップの調査計画に基づき実行 |
| **コード実行** | Python実行環境との統合あり | 基本的なデータ分析機能あり |
| **レポート形式** | 構造化されたテキストレポート（見出し、引用あり） | 整理されたレポート（Googleドキュメントへのエクスポート機能あり） |
| **調査計画** | 自動的に作成 | ユーザーが承認/修正可能な調査計画を提示 |
...
[OpenAI Deep Research](https://openai.com/index/introducing-deep-research/) | [Google Gemini Deep Research](https://blog.google/products/gemini/google-gemini-deep-research/)
...
### OpenAI関連
- [OpenAI Deep Research公式紹介ページ](https://openai.com/index/introducing-deep-research/)
  * OpenAIによるDeep Research機能の公式発表と説明

### Google関連
- [Google Blog: Deep Research紹介記事](https://blog.google/products/gemini/google-gemini-deep-research/)
  * GoogleによるGemini Deep Researchの公式発表と機能紹介
- [Gemini Deep Research公式ページ](https://gemini.google/overview/deep-research/)
  * Google Geminiの公式サイトにおけるDeep Research機能の説明ページ

## 使用レビューと実践例

### Qiitaの紹介・解説記事
- [ChatGPT 新機能「Deep Research」徹底解説＆使用レビュー](https://qiita.com/syukan3/items/b2bd98d2f61a75777d38)
  * OpenAIのDeep Research機能の詳細解説と、実際に使用した体験レポート
- [OpenAI Deep Research のオープンソース化：概要とMacローカル実装ガイド](https://qiita.com/syukan3/items/c0bc4fe6e097105076c6)
  * Deep Researchをオープンソースで実装する取り組みについての説明

### 使用体験レポート
- [【超優秀】話題のDeep Research（ディープリサーチ）を試してみた](https://pulse-ai.jp/media/trial_deep_research/)
  * PULSE AI mediaによる実際のDeep Research使用体験と詳細な結果レポート

### その他の参考記事
- [人類は勝てない? ChatGPTで本格調査レポートを作成「deep research」](https://www.watch.impress.co.jp/docs/topic/1660336.html)
  * Deep Researchの基本機能と使い方についての解説記事
- [ChatGPTの「deep research」でオフィスワークの自動化が進む？](https://wired.jp/article/openais-deep-research-agent-is-coming-for-white-collar-work/)
  * WIREDによるDeep Researchのビジネス活用についての考察

## ガイド・チュートリアル関連

- [Google: 6 tips to get the most out of Gemini Deep Research](https://blog.google/products/gemini/tips-how-to-use-deep-research/)
  * GoogleによるGemini Deep Researchを効果的に活用するためのヒント集
- [Use Gemini Apps for in-depth research - Google Help](https://support.google.com/gemini/answer/15719111?hl=en)
  * Google Gemini Deep Researchの公式使用ガイド

## YouTube解説動画

- [最強AI検索！ChatGPTのDeep Researchを解説【ガチで使える活用法】](https://www.youtube.com/watch?v=EFvE1GaB5fM)
  * ChatGPT Deep Researchの使い方と活用方法を解説した動画
- [話題の検索AIエージェント！OpenAI Deep Researchについて解説してみた](https://www.youtube.com/watch?v=fES4j8oDN1M)
  * OpenAI Deep Researchの機能と特徴を解説する動画
