import { SearchIndexRepository, SearchIndexSyncInput } from '../../domain/ports/search-index-repository.js'
import { CommandRunner } from '../../application/ports/command-runner.js'

export class AwsS3SearchIndexRepository implements SearchIndexRepository {
